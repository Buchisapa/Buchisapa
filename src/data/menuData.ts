...
export const PROMOTIONS: PromotionItem[] = [
  {
    ...
    items: ["1 Salchibroaster Pecho", "1 Salchipapa Clásica", "2 Refrescos 1/2L"],
  },
  {
    id: "promo-2",
    ...
    originalPrice: 42.00,
    tag: "MÁS VENDIDO",
    description: "1 Tacacho con Cecina + 1 Pecho Broaster con papas y ensalada + 1 Refresco Cocona",
    items: ["1 Tacacho con Cecina", "1 Pecho Broaster", "1 Refresco Cocona"],
  },
  {
    id: "promo-3",
    title: "Dúo Hamburguesas Hawaianas",
    price: 22.00,
    originalPrice: 26.00,
    tag: "OFERTA",
    description: "2 Hamburguesas Hawaianas (Carne o Pollo) + 2 Bebidas Inca Kola / Coca Cola",
    items: ["2 Hamburguesas Hawaianas", "2 Bebidas 500ml"],
  },
  {
    id: "promo-4",
    title: "Combo Alitas & Papas x10",
    price: 28.00,
    originalPrice: 34.00,
    tag: "PARA COMPARTIR",
    description: "10 Alitas crocantes (Acevichadas o BBQ) + porción familiar de papas fritas",
